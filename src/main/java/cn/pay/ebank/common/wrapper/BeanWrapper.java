...
/*
 * 修订记录:
 * zhyang@ebank.pay.cn 2015-04-21 22:16 创建
 *
 */
package cn.pay.ebank.common.wrapper;


import cn.pay.ebank.common.beans.conversion.TypeConverterManager;
...
public interface BeanWrapper {
	...
	/**
	 * 通过属性路径表达式得到对应的属性包装器列表。得到的属性包装器列表的下标对应了属性路径表达式的每一段的下标，
	 * 每个属性包装器包装了对应bean的属性名对应的属性。
	 *
	 ...
	 */
	boolean setPropertyValue (String propertyPath, Object value, PropertyAccessCallback callback) throws Exception;
	...
	public static interface PropertyAccessCallback {
		 ...
		 * @throws Exception 如果过程中发生异常。
		 */
		Object propertyWrite (PropertyWrapper propertyWrapper, PropertyAccessor propertyAccessor, TypeConverterManager typeConverterManager) throws Exception;
		 ...
		 * @throws Exception 如果过程中发生异常。
		 */
		Object lastPropertyWrite (Object value, PropertyWrapper propertyWrapper, PropertyAccessor propertyAccessor, TypeConverterManager typeConverterManager) throws Exception;
