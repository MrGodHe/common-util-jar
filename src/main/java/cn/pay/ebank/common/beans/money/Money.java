...
/*
 * 修订记录:
 * zhyang@ebank.pay.cn 2015-05-13 19:45 创建
 *
 */
package cn.pay.ebank.common.beans.money;

import java.io.Serializable;
import java.math.BigDecimal;

import cn.pay.ebank.common.beans.enums.CurrencyEnum;
...
public class Money implements Serializable, Comparable<Money> {
	...
	public Money(String amount) {
		this(amount == null ? "" : amount.replace(",", ""), DEFAULT_CURRENCY);
	}
	...
	public String toCNString() {
		return MoneyUtils.getCHSNumber(this);
	}
