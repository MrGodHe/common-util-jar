...
/**
 * {@link java.math.BigInteger}的类型转换器。
 * 
...
public class BigIntegerTypeConverter extends AbstractTypeConverter<BigInteger> {
	...
	public List<Class<?>> getSupportedSourceTypes() {
		return Arrays.asList(Number.class, Boolean.class, Character.class, CharSequence.class, CharSequence[].class, BigDecimal.class);
	}
