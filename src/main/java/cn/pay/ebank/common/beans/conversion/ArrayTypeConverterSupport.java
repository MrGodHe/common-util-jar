...
abstract class ArrayTypeConverterSupport<T> extends AbstractTypeConverter<T> {
	...
	@SuppressWarnings("unchecked")
	public static Object arrayValue(Class<? extends Object> toType, Object value, TypeConverterManager typeConverterManager) {
		Object result = null;
		...
		if (sourceType.isArray() && toType.isArray()) {
			...
			TypeConverter<Object> typeConversion = (TypeConverter<Object>) typeConverterManager.getTypeConverter(sourceType.getComponentType(),
				componentType);
