...
/*
 * 修订记录:
 * zhyang@ebank.pay.cn 2015-05-13 18:50 创建
 *
 */
...
public class DigestUtils {
	...
	private static final Logger logger = LoggerFactory.getLogger (DigestUtils.class.getName ());
	 ...
	 */
	public static void checkWithTimestamp(HttpServletRequest request, String securityCheckKey, DigestALGEnum de, String charset, long expireTime,
	                                      TimeUnit timeUnit) {
