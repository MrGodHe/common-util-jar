...
/*
 * 修订记录:
 * zhyang@ebank.pay.cn 2015-04-21 19:55 创建
 *
 */
...
import cn.pay.ebank.common.beans.InstantiationRuntimeException;
import cn.pay.ebank.common.beans.conversion.TypeConverterUtils;
import cn.pay.ebank.common.beans.property.PropertyAccessor;
import cn.pay.ebank.common.beans.property.PropertyWrapper;
import cn.pay.ebank.common.wrapper.BeanWrapper;
import cn.pay.ebank.common.wrapper.BeanWrapperProvider;
 ...
 * <p/>
 * 该工具中支持bean参数（bean属性）路径表达式的方法所使用的 {@link BeanWrapper} 由
 * {@link BeanWrapperProvider} 提供。 {@link BeanWrapperProvider} 由
 * {@link ServiceLoader} 从 <code>service/common/base/</code> 进行加载。
 * <p/>
...
public class ReflectionUtils {
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeMethod (Object object, String methodName, Object... parameters) throws NoSuchMethodException {
		Class<?>[] parameterTypes = ObjectParameterUtils.processParameterToParameterType (parameters);
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeMethod (Object object, String methodName, Class<?>[] parameterTypes, Object[] parameters) throws NoSuchMethodException {
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误
	 */
	public static Object executeClassMethod (Object object, String methodName, Object... parameter) throws NoSuchMethodException {
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeClassMethod (Object object, String methodName, Class<?>[] parameterTypes, Object[] parameter) throws NoSuchMethodException {
		Class<?> clazz = object.getClass ();
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeStaticMethod (Class<?> clazz, String methodName, Class<?>[] parameterTypes, Object[] parameter) throws NoSuchMethodException {
		Method method = clazz.getMethod (methodName, parameterTypes);
		methodSetAccessible (method);
		try {
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeStaticMethod (Class<?> clazz, String methodName, Object... parameter) throws NoSuchMethodException {
		Class<?>[] parameterTypes = ObjectParameterUtils.processParameterToParameterType (parameter);
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误
	 */
	public static Object executeStaticMethod (String className, String methodName, Class<?>[] parameterTypes, Object[] parameter) throws NoSuchMethodException {
	 ...
	 * @throws CommonException                  如果执行方法时发生除方法自身错误外的其他错误。
	 */
	public static Object executeStaticMethod (String className, String methodName, Object... parameter) throws NoSuchMethodException {
		Class<?>[] parameterTypes = ObjectParameterUtils.processParameterToParameterType (parameter);
	 ...
	 * @throws InvocationTargetRunTimeException 如果构造方法抛出异常。
	 */
	public static <T> T createObject (Class<T> clazz, Class<?>[] parameterTypes, Object[] parameters) throws NoSuchMethodException {
		if (clazz == null) {
			throw new InstantiationRuntimeException ("不能 'null' 创建实例。");
		}
	...
	public static <T> T createObject (String className, Object... parameters) throws NoSuchMethodException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T createObject (String className, ClassLoader classLoader, Object... parameters) throws NoSuchMethodException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T createObject (String className, ClassLoader classLoader) throws NoSuchMethodException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T createObject (String className, ClassLoader classLoader, Class<?>[] parameterTypes, Object[] parameters) throws NoSuchMethodException {
		return (T) createObject (ClassUtils.applicationClass (className, classLoader), parameterTypes, parameters);
	}
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T createObject (String className, Class<?>[] parameterTypes, Object[] parameters) throws NoSuchMethodException {
	 ...
	 * @param paramMap 以字段名为key，参数值为value的{@link java.util.Map}。
	 * @throws CommonException 发生异常时。
	 */
	 ...
	 * 如果注入类型与值的类型兼容，则直接注入。
	 * <p/>
	 * 当注入的类型为 {@link java.util.List} 时，会使用 {@link java.util.ArrayList} 作为实现注入，当注入类型为 {@link java.util.Queue}
	 * 时，会使用 {@link java.util.LinkedList} 作为实现注入，当注入类型为 {@link java.util.Set} 时，会使用 {@link java.util.HashSet}
	 * 作为实现注入， 如果为 {@link java.util.Date} 类型，则将值转化为 long 作为 {@link java.util.Date}
	 * 的构造参数值构造新实例注入。当类型为其他接口时，抛出异常。
	 * <p/>
	 * 如果 写入方法 中对应名称在 parameterMap 中没有相应的值 ，那么，如果 写入方法 对应的类型为 Collection/数组
	 * ，则注空的 Collection实例/数组，如果为其他，则注入 null。
	 *
	 ...
	 */
	public static void injectionObject (Object object, Map<String, ? extends Object> parameterMap) throws NoSuchMethodException {
	 ...
	 * @throws CommonException 发生异常时。
	 */
	public static void setter (Object object, String name, Object value) throws NoSuchMethodException {
		try {
	...
	public static Object getParameter (Object object, String parameterName) {
		...
		if (propertyWrappers.isEmpty ()) {
			throw new CommonException (new NoSuchMethodException ("没有表达式 '" + parameterName + "' 对应的属性的get方法。"));
		}
	 ...
	 * @throws InvocationTargetRunTimeException 如果基础方法抛出异常。
	 * @throws CommonException                  发生其他异常时。
	 */
	 ...
	 */
	public static Class<?> getPropertyClass (Class<?> clazz, String name) throws NoSuchFieldException {
		BeanInformation<?> beanInfo = ObjectUtils.getCacheBeanInfo (clazz);
		return getPropertyClass (beanInfo, name);
	}

	static Class<?> getPropertyClass (BeanInformation<?> beanInfo, String name) throws NoSuchFieldException {
		PropertyDescriptor propertyDescriptor = beanInfo.getPropertyDescriptor (name);
		if (propertyDescriptor == null) {
			throw new NoSuchFieldException ("[" + beanInfo.getBeanDescriptor ().getName () + "] 中没有字段'" + name + "'.");
		}
	 ...
	 * @throws NoSuchFieldException 如果找不到带有指定名称的属性。
	 */
	public static Class<?> getPropertyClass (Object object, String name) throws NoSuchFieldException {
	 ...
	 * @throws CommonException      发生其他异常。
	 */
	public static void executeFieldValue (Object object, String fieldName, Object parameter) throws NoSuchFieldException {
	...
	public static Method getSetterMethod (Class<?> clazz, String name) throws NoSuchMethodException {
		...
		if (propertyDescriptor == null || (writeMethod = propertyDescriptor.getWriteMethod ()) == null) {
			throw new NoSuchMethodException ("[" + clazz.getName () + "] 中没有字段 '" + name + "' 对应的访问方法。");
		}
		return writeMethod;
	}
	...
	public static Method getGetterMethod (Class<?> clazz, String name) throws NoSuchMethodException {
		...
		if (propertyDescriptor == null || (readMethod = propertyDescriptor.getReadMethod ()) == null) {
			throw new NoSuchMethodException ("[" + clazz.getName () + "] 中没有字段 [" + name + "]对应的读取方法.");
		}
		return readMethod;
	}
	 ...
	 */
	public static MethodDescriptor getMethodDescriptor (Class<?> clazz, String name, Class<?>... classes) {
	 ...
	 * @return 合适的 MethodDescriptor ，如果不存在则返回 null。
	 */
	public static MethodDescriptor getMethodDescriptor (Object object, String name, Class<?>... classes) {
	 ...
	 * 语言访问检查。
	 * <p/>
	 * 如果存在安全管理器,则在启用特权的情况下执行 {@link java.lang.reflect.Method#setAccessible(boolean)}。
	 *
	 ...
	 * <p/>
	 * 如果存在安全管理器,则在启用特权的情况下执行 {@link java.lang.reflect.Field#setAccessible(boolean)}。
	 *
	 ...
	 * Java 语言访问检查。
	 * <p/>
	 * 如果存在安全管理器,则在启用特权的情况下执行 {@link java.lang.reflect.Constructor#setAccessible(boolean)}。
	 *
