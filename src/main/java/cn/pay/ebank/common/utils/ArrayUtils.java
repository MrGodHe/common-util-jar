...
public class ArrayUtils {
	...
	public static Object[] defaultIfEmpty(Object[] array, Class<?> defaultComponentType) {
		return ((array == null) || (array.length == 0)) ? (Object[]) Array.newInstance(ClassUtils.getNonPrimitiveType(defaultComponentType), 0)
				: array;
	}
	 ...
	 * @return 追加元素后的数组
	 */
	public static <T> T[] append (T[] arrays, T... ts) {
		return join (arrays, ts);
	}
